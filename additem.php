...
if(isset($_POST)){
    if(!empty($_POST)){
        if($_POST['action']=='edit'){
            ...
            if(insertItem($_POST,$_FILES['image'])){
            ...
            <div class="addItem_form">
                ...
                <select name="category" id="category" required>
                    ...
                    foreach($category as $index=>$cat){
                        ?>
                        <option value="<?php echo $cat['id'] ?>" <?php if($item['category']){if($item['category']==$cat['id']){echo "selected";}}?>><?php echo $cat['categories']; ?></option>
                        <?php
                    }
                    ?>
                </select>
